...
export default function ProveedorFillData({
  proveedor,
  editable,
}: {
  ...
  const onSubmit = handleSubmit(async (data) => {
    ...
    try {
      const data = await updateProveedor(token, id, proveedorCreacion);
      ...
      {proveedor && (
        <div className="flex flex-col gap-4">
          ...
          <input
            ...
            type="text"
            id="nombres"
            defaultValue={proveedor.nombres}
            readOnly={!editable}
            {...register("nombres", {
              required: {
                value: true,
          ...
          <input
            ...
            type="text"
            id="apellidos"
            defaultValue={proveedor.apellidos}
            readOnly={!editable}
            {...register("apellidos", {
              required: {
                value: true,
          ...
          <textarea
            className="px-4 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-400 bg-gray-100"
            id="ubicacion"
            defaultValue={proveedor.ubicacion}
            readOnly={!editable}
            {...register("ubicacion", {
              required: {
                value: true,
          ...
          {editable ? (
            <>
              ...
              >
                <option value={proveedor.estadoId}>
                  {proveedor.estado}
                </option>
                {proveedor.estadoId == estados.Activo ? (
